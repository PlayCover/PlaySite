...
<template>
  <div class="max-w-[1350px] md:mx-auto">
    ...
    <div v-if="isMobileNavOpen" class="absolute md:hidden bg-light dark:bg-dark z-50 w-full border-b border-b-gray-400/20 dark:border-b-gray-200/5 absolute z-50">
